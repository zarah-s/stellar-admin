          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                ...
                <a href="pages/samples/logout.php" class="dropdown-item"><i class="dropdown-item-icon icon-power text-primary"></i>Sign Out</a>
              </div>
            </li>
          </ul>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="pages/tables/users.php">
                <span class="menu-title">Registered students</span>
                <i class="icon-screen-desktop menu-icon"></i>
              </a>
              <a class="nav-link" href="pages/tables/verify.php">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Number of Registered students</h4>
                ...
                <div class="card">
                  ...
                  <div class="d-md-flex row m-0 quick-action-btns" role="group" aria-label="Quick action buttons">
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <a href="pages/samples/register.php" class="btn px-0"> <i class="icon-user mr-2"></i> Add Student</a>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <a href="pages/tables/users.php" class="btn px-0"><i class="icon-docs mr-2"></i> All Students</a>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row report-inner-cards-wrapper">
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Number of Registered Students</span>
                          <h4>95,458</h4>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">No of male students</span>
                          <h4>2650</h4>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">No of female students</span>
                          <h4>25,542</h4>
